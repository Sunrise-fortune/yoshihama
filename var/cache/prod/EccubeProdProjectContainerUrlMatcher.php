...
class EccubeProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin_yoshihama')) {
            // admin_login
            if ('/admin_yoshihama/login' === $pathinfo) {
            ...
            // admin_homepage
            if ('/admin_yoshihama' === $trimmedPathinfo) {
            ...
            if (0 === strpos($pathinfo, '/admin_yoshihama/s')) {
                // admin_homepage_sale
                if ('/admin_yoshihama/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/se')) {
                    // admin_homepage_nonstock
                    if ('/admin_yoshihama/search_nonstock' === $pathinfo) {
                    ...
                    if ('/admin_yoshihama/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/admin_yoshihama/setting/shop/csv') && preg_match('#^/admin_yoshihama/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/admin_yoshihama/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/admin_yoshihama/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_yoshihama/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/admin_yoshihama/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/admin_yoshihama/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_yoshihama/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/admin_yoshihama/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/admin_yoshihama/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/admin_yoshihama/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_yoshihama/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_yoshihama/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/admin_yoshihama/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/admin_yoshihama/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/admin_yoshihama/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_yoshihama/setting/system')) {
                        // admin_setting_system_authority
                        if ('/admin_yoshihama/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/admin_yoshihama/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_yoshihama/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/admin_yoshihama/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/admin_yoshihama/setting/system/member' === $pathinfo) {
                            ...
                            if ('/admin_yoshihama/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/admin_yoshihama/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/admin_yoshihama/setting/system/system' === $pathinfo) {
                            ...
                            if ('/admin_yoshihama/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_yoshihama/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/admin_yoshihama/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/admin_yoshihama/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/shipping/preview_notify_mail') && preg_match('#^/admin_yoshihama/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/shipping/notify_mail') && preg_match('#^/admin_yoshihama/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_yoshihama/store/plugin')) {
                    if (0 === strpos($pathinfo, '/admin_yoshihama/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/admin_yoshihama/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/admin_yoshihama/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/admin_yoshihama/store/plugin/api/search/page') && preg_match('#^/admin_yoshihama/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/admin_yoshihama/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/admin_yoshihama/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/store/plugin/api/delete') && preg_match('#^/admin_yoshihama/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/admin_yoshihama/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/admin_yoshihama/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/admin_yoshihama/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_yoshihama/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_yoshihama/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/admin_yoshihama/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_yoshihama/store/template')) {
                    // admin_store_template
                    if ('/admin_yoshihama/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_yoshihama/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_yoshihama/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/admin_yoshihama/c')) {
                // admin_change_password
                if ('/admin_yoshihama/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/content')) {
                    if (0 === strpos($pathinfo, '/admin_yoshihama/content/block')) {
                        // admin_content_block
                        if ('/admin_yoshihama/content/block' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/admin_yoshihama/content/cache' === $pathinfo) {
                    ...
                    // admin_content_css
                    if ('/admin_yoshihama/content/css' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/content/file_')) {
                        // admin_content_file
                        if ('/admin_yoshihama/content/file_manager' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/content/file_view' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/content/file_delete' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/content/file_download' === $pathinfo) {
                    ...
                    // admin_content_js
                    if ('/admin_yoshihama/content/js' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/content/layout')) {
                        // admin_content_layout
                        if ('/admin_yoshihama/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_yoshihama/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/content/news')) {
                        // admin_content_news
                        if ('/admin_yoshihama/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/content/news/page') && preg_match('#^/admin_yoshihama/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_yoshihama/content/page')) {
                        // admin_content_page
                        if ('/admin_yoshihama/content/page' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/admin_yoshihama/customer')) {
                    // admin_customer
                    if ('/admin_yoshihama/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/admin_yoshihama/customer/page') && preg_match('#^/admin_yoshihama/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_yoshihama/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_yoshihama/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/admin_yoshihama/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/admin_yoshihama/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/admin_yoshihama/order')) {
                // admin_shipping_csv_import
                if ('/admin_yoshihama/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/admin_yoshihama/order/csv_template' === $pathinfo) {
                ...
                // admin_order_new
                if ('/admin_yoshihama/order/new' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/admin_yoshihama/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/order/search')) {
                    if (0 === strpos($pathinfo, '/admin_yoshihama/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/admin_yoshihama/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/order/search/customer/html/page') && preg_match('#^/admin_yoshihama/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_yoshihama/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/order/search/product')) {
                        // admin_order_search_product
                        if ('/admin_yoshihama/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/admin_yoshihama/order/search/product/page') && preg_match('#^/admin_yoshihama/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_yoshihama/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/admin_yoshihama/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_yoshihama/order/mail/view' === $pathinfo) {
                ...
                // admin_order
                if ('/admin_yoshihama/order' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/admin_yoshihama/order/page') && preg_match('#^/admin_yoshihama/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_yoshihama/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/order/export')) {
                    // admin_order_export_order
                    if ('/admin_yoshihama/order/export/order' === $pathinfo) {
                    ...
                    if ('/admin_yoshihama/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/admin_yoshihama/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/admin_yoshihama/product')) {
                if (0 === strpos($pathinfo, '/admin_yoshihama/product/c')) {
                    if (0 === strpos($pathinfo, '/admin_yoshihama/product/category')) {
                        // admin_product_category
                        if ('/admin_yoshihama/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/product/category/export' === $pathinfo) {
                        ...
                        if ('/admin_yoshihama/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_yoshihama/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/admin_yoshihama/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/admin_yoshihama/product/class_name')) {
                        // admin_product_class_name
                        if ('/admin_yoshihama/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/admin_yoshihama/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/admin_yoshihama/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/admin_yoshihama/product/csv_template') && preg_match('#^/admin_yoshihama/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_yoshihama/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/admin_yoshihama/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product
                if ('/admin_yoshihama/product' === $pathinfo) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/admin_yoshihama/product/page') && preg_match('#^/admin_yoshihama/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/product/product')) {
                    // admin_product_image_add
                    if ('/admin_yoshihama/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/admin_yoshihama/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_yoshihama/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/admin_yoshihama/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/product/classes') && preg_match('#^/admin_yoshihama/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/admin_yoshihama/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/product/bulk/product-status') && preg_match('#^/admin_yoshihama/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin_yoshihama/product/tag')) {
                    // admin_product_tag
                    if ('/admin_yoshihama/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/admin_yoshihama/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/admin_yoshihama/product/tag/sort_no/move' === $pathinfo) {
            ...
            // admin_logout
            if ('/admin_yoshihama/logout' === $pathinfo) {
